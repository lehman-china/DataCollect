...
public class LoginZJMobile {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String url = "https://zj.ac.10086.cn/login";//sc
        ...
        do {
            ...
            Tools.saveToLocal(httpClient.execute(new HttpGet(url)).getEntity(), "zjimg.png");
...
//        </html>
        ...
        url = "http://www.zj.10086.cn/my/queryPresentFlow.do?AISSO_LOGIN=true";
        result = EntityUtils.toString(httpClient.execute(new HttpGet(url)).getEntity()) ;
...
//        <a href="http://service.zj.10086.cn/yw/bill/billDetailBefore.do?bid=BD399F39E69248CFE044001635842131" target="_blank" title="历史月账单查询"
//        <a href="http://service.zj.10086.cn/yw/bill/billDetail.do?bid=BD399F39E69148CFE044001635842132&amp;month=0" target="_blank" title="实时账单查询"
//        <a href="http://service.zj.10086.cn/yw/bill/billDetailBefore.do?bid=BD399F39E69248CFE044001635842131" target="_blank" title="历史月账单查询"
...
//        if(matcher.find()){
//            url="http://service.zj.10086.cn"+StringEscapeUtils.unescapeHtml4(matcher.group(1));
//        }


        //[基本信息],要发短信才能查看
        url="http://www.zj.10086.cn/my/userinfo/userYdinfoFirst.jsp";
        result = EntityUtils.toString(httpClient.execute(new HttpGet(url)).getEntity()) ;

        //发送短信验证码
        url="http://www.zj.10086.cn/my/userinfo/sendMessage.do";
        result = EntityUtils.toString(httpClient.execute(new HttpGet(url)).getEntity()) ;
